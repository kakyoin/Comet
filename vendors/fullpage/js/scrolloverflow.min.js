...
(function(g, q, f) {
    ...
    function v(a, b) {
        ...
        if (this.options.fade) { this.wrapperStyle[d.style.transform] = this.scroller.translateZ;
            var e = d.style.transitionDuration;
            if (e) { this.wrapperStyle[e] = d.isBadAndroid ? "0.0001ms" : "0ms";
                var f = this;
    ...
    var t = g.requestAnimationFrame || g.webkitRequestAnimationFrame ||
        ...
        d = function() {
            ...
            b.momentum = function(a, b, c, e, d, k) { b = a - b;
                c = f.abs(b) / c;
                var g;
                k = void 0 === k ? 6E-4 : k;
                g = a + c * c / (2 * k) * (0 > b ? -1 : 1);
            ...
            b.extend(b.ease = {}, {
                quadratic: { style: "cubic-bezier(0.25, 0.46, 0.45, 0.94)", fn: function(a) {
                        return a * (2 - a) } },
    ...
    p.prototype = {
                ...
                if (!(300 < k - this.endTime && 10 > b && 10 > h)) {
                    ...
                    if ("h" == this.directionLocked) {
                        if ("vertical" == this.options.eventPassthrough) a.preventDefault();
                            ...
                            this.options.eventPassthrough) { this.initiated = !1;
                            return }
                        e = 0
        ...
        _transitionTime: function(a) {
            if (this.options.useTransition) { a = a || 0;
                var b = d.style.transitionDuration;
                if (b) { this.scrollerStyle[b] = a + "ms";
                    if (!a && d.isBadAndroid) { this.scrollerStyle[b] = "0.0001ms";
                        var c = this;
    ...
    v.prototype = {
        ...
        _pos: function(a, b) { 0 > a ? a = 0 : a > this.maxPosX && (a = this.maxPosX);
        ...
        fade: function(a,
            b) {
            if (!b || this.visible) { clearTimeout(this.fadeTimeout);
